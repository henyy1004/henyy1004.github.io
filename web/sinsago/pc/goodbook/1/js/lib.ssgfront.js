...
function showLayer(id) {
    ...
    $("#styleInsert").append('<link rel="stylesheet" type="text/css" href="http://truebook.sinsago.co.kr/css/popup.css" />');
	var loginPop = $("#" + id);
...
function showDeliveryInfo(invoiceNo, deliveryCustCd) {
	...
	// 롯데
		...
		window.open(" https://www.lotteglogis.com/open/tracking?invno=" + invoiceNo, "ShowDeliveryInfo", 'width=500,height=700,scrollbars=yes');
	}
}
