...
var uiHeader = function uiHeader() {
  ...
  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_0___default()(GnbActionItem).call(GnbActionItem, function (item, index) {
  ...
  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_0___default()(GnbItem).call(GnbItem, function (item, index) {
    var keyDownkHandler = function keyDownkHandler(event) {
      switch (event.keyCode) {
        case keyCode.UP:
          close();
...
var uiTooltip = function uiTooltip() {
  // 툴팁 다 가져오기
  var toolTipArray = document.querySelectorAll('.toolitp-open'); // 각 툴팁버튼에 이벤트달기

  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_0___default()(toolTipArray).call(toolTipArray, function (item, index) {
    // 툴팁 열림닫힘 상태
    var hasPopup = false; // 버튼이 제어하는 툴팁노드

    var controls = document.getElementById(item.getAttribute('aria-controls')); // 키코드정의
...
var uiMenuList = function uiMenuList() {
  // 메뉴리스트버튼 다 가져오기
  var menuListArray = document.querySelectorAll('.btn-menulist'); // 팝업 열림닫힘 상태

  var hasPopup = false; // 키코드정의
  ...
  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_0___default()(menuListArray).call(menuListArray, function (item, index) {
    // 버튼이 제어하는 메뉴리스트노드
    var controls = document.getElementById(item.getAttribute('aria-controls')); // 메뉴리스트노드의 마지막 요소
